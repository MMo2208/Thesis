...
\end{itemize}
\ \\
So while the JES is that part of z/OS which is responsible for reading and processing the JCL that shall be transmitted from the front-end it should work as a contact system to be addressed by the application. The next chapters will introduce the way how to contact the Job-Entry-Subsystem to be able to submit jobs directly to it.
\newpage
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{img/hipersockets.jpg}
