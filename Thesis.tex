...
file, but a z/OS batch job migh
t process millions of records.}\\
...
\subsection{Access with Virtual Switch / HiperSockets / TCP/IP}
\url{http://www.redbooks.ibm.com/redbooks/pdfs/sg246816.pdf}

\subsection{Access through Java with FTP}
\url{https://www.ibm.com/developerworks/systems/library/es-zosbatchjavav/es-zosbatchjavav-pdf.pdf}

\subsection{Access via SSH/SFTP - z/OS Remote Services Processing Model - Co:Z}
